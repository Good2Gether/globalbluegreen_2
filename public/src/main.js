...
// **********************
    ...
    var SVO_instruction = {
      ...
      <br> 
      <br>
      <b> 100 points are worth 0.37$ (about 106 Rupee).  </b>
     ...
     var star_instructions = {
      ...
      stimulus: function(){
        return `
         ...
         <p>${globalgroup_text} wins if you gather more points than ${globalothergroup_text}. The winning team gets a bonus payment of 0.75$ (about 212  Rupee). </br> </br></p> 
 ...
 var star_test_stimuli = [
    ...
    var choice_instructions1 = {
      ...
      <p> 100 points are worth 0.37$ (about 106 Rupee). Each decision you make has the same chance to be picked to be paid out.<p/> 
    ...
    var lookcheck_trial = {
      ...
      stimulus: function() {
        return `
         <p>In this task, you have 100 points that are worth 0.37$ (about 106 Rupee).</p> 
