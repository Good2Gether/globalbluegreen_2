   ...
   /* preload images */
    ...
    var jsPsych = initJsPsych({
      ...
      on_trial_finish: function () {if(successExp) {
        ...
        Your survey code is: <b> <b>Cog${randomCode}Glo27</b></br>
...
// **********************
     ...
     var star_instructions = {
      ...
      stimulus: function(){
        return `
         ...
         <p>${globalgroup_text} wins if you gather more points than ${globalothergroup_text}. The winning team gets a bonus payment of 0.75$ (about 60 Rupee). </br> </br></p> 
 ...
 var star_test_stimuli = [
    ...
    var choice_instructions1 = {
      ...
      <p> 100 points are worth 0.37$ (about 30 Rupee). Each decision you make has the same chance to be picked to be paid out.<p/> 
